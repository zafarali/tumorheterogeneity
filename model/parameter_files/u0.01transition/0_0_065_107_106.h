...
const int stop_mutating_size=int(1e6); // stop creating new mutations after reaching this size.
...
#ifdef __MAIN
int max_size=int(2.4e7) ; // this is ignored when MAKE_TREATMENT_T is defined
